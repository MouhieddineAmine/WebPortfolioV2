      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6 bg-[#041224] p-6 rounded-xl shadow-lg">
            ...
            <div className="space-y-4 text-sm font-semibold">
              ...
              <p className="flex items-center gap-3">
                ...
                >
                  <span className={`${isRVerified ? '' : 'blur-[2px]'} transition break-words`}>https://www.linkedin.com/in/mouhieddine-amine-0b9837269/</span>
                </a>
              </p>
          ...
          >
            ...
            theme="dark"/>
            {recaptchaError && (
              <p className={`text-red-500 text-sm mt-[5px] mb-[5px] text-center transition-opacity duration-200 ${
