...
<div className="card min-h-screen px-5 sm:px-12 bg-[#010812] text-white pt-[35px] mx-0 sm:mx-5 pb-[60px] rounded-xl">
      <div className="max-w-6xl mx-auto">
        <BtnGoBackProject />
        <h1 className="typetext text-4xl font-bold mb-5 mt-10">Smart Calculator</h1>
        <p className="description text-gray-400 mb-[20px]">Smart Calculator is a desktop replica of the iPhone calculator, enhanced with a few extra functions like square root and factorial. 
...
<section className="detail-bg bg-[#0f1624] rounded-lg p-6 mt-16 mb-10 shadow-md">
  ...
  <ul className="description text-gray-300 list-disc list-inside space-y-2 pl-2">
    ...
    <li><span className="typetext text-white font-medium">MVVM Pattern</span> — clean and maintainable architecture</li>
  </ul>
</section>
